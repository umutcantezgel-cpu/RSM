...
Output Requirements:
- Your working directory is `/Users/umurey/Downloads/RSM/.agents/challenger_m1_1`.
- Write your verification findings to `/Users/umurey/Downloads/RSM/.agents/challenger_m1_1/challenger.md` and deliver `handoff.md`.
